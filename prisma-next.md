...
Your data contract is the heart of your application. It lives at [`app/generated/prisma/contract.prisma`](app/generated/prisma/contract.prisma) and describes your models:
...
```typescript
import { db } from './app/generated/prisma/db';
...
export default definePrismaConfig({
  orm: ormConfig({
    contract: './app/generated/prisma/contract.prisma',
    db: {
...
| File | Purpose |
|---|---|
| [`app/generated/prisma/contract.prisma`](app/generated/prisma/contract.prisma) | Your data contract — define your models here |
| [`prisma.config.ts`](prisma.config.ts) | CLI configuration |
| [`app/generated/prisma/db.ts`](app/generated/prisma/db.ts) | Database client — `import { db } from './app/generated/prisma/db'` |
| `app/generated/prisma/contract.json` | Compiled contract (generated) |
| `app/generated/prisma/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`app/generated/prisma/contract.prisma`](app/generated/prisma/contract.prisma) to add or change models.
